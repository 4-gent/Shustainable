        ...
        <div className="overlap">
          <div className="post">
            <div className="overlap-group">
              <div className="div" />
              <img className="image" alt="Image" src="https://c.animaapp.com/SPyf3cca/img/image-2.png" />
              <img
              ...
              <div className="post-info">
                <div className="save-like">
                  <img className="vector" alt="Vector" src="https://c.animaapp.com/SPyf3cca/img/vector-2-1.png" />
                ...
                <img className="TS-pfp" alt="Ts pfp" src="https://c.animaapp.com/SPyf3cca/img/ts-pfp.png" />
              </div>
            </div>
          </div>
          <div className="overlap-group-wrapper">
            <div className="overlap-group">
              ...
              <div className="save-like-2">
                <img className="vector" alt="Vector" src="https://c.animaapp.com/SPyf3cca/img/vector-2.svg" />
                <div className="overlap-group-2">
                  <img className="img" alt="Group" src="https://c.animaapp.com/SPyf3cca/img/group-3-5@2x.png" />
                  <div className="text-wrapper">109</div>
                </div>
              </div>
              <div className="OP-2">
                <img className="ellipse" alt="Ellipse" src="https://c.animaapp.com/SPyf3cca/img/ellipse-3@2x.png" />
                <div className="group-3">
                  <div className="text-wrapper-2">Shylla Monic</div>
                  <p className="p">2023 . 04 . 06</p>
                </div>
              </div>
              <img className="image-2" alt="Image" src="https://c.animaapp.com/SPyf3cca/img/image-1@2x.png" />
              <div className="flexcontainer">
                <p className="text">
                  <span className="span">
                    Grow your own fruits and veggies to avoid buying plastic packaging<br />
                  </span>
                </p>
              </div>
            </div>
...
\          <div className="tip-section-header">
            <div className="overlap-2">
              ...
              <p className="text-wrapper-3">Vote for your favorite to be the tip of the day or submit your own!</p>
